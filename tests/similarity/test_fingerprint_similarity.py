...
def test_fingerprint_similarity_parallel(test_method, expected_score, array_type, set_empty):
    ...
    similarity_measure = CudaFingerprintSimilarity(set_empty_scores=set_empty, similarity_measure=test_method)
...
def test_fingerprint_similarity_with_scores_sorting():
    ...
    similarity_measure = CudaFingerprintSimilarity(set_empty_scores=0, similarity_measure="cosine")
